...
namespace AKSaigyouji
{
    ...
    /// Handles values between -32768 and 32767.
    /// </summary>
    [Serializable]
    public struct Coord : IEquatable<Coord>
    {
        ...
        /// (1,1)
        /// </summary>
        public static readonly Coord topRight = new Coord(1, 1);

        /// <summary>
        /// (1,-1)
        /// </summary>
        public static readonly Coord bottomRight = new Coord(1, -1);

        /// <summary>
        /// (-1,1)
        /// </summary>
        public static readonly Coord topLeft = new Coord(-1, 1);

        /// <summary>
        /// (-1,-1)
        /// </summary>
        public static readonly Coord bottomLeft = new Coord(-1, -1);
        ...
        public static Vector2 operator *(float c, Coord tile)
        {
            return new Vector2(c * tile.x, c * tile.y);
        }
        ...
        public static Coord operator /(Coord tile, int c)
        {
            return new Coord(tile.x / c, tile.y / c);
        }

        public static Vector2 operator /(Coord tile, float c)
        {
            return new Vector2(tile.x / c, tile.y / c);
        }
        ...
        public struct LineEnumerator : IEnumerator<Coord>
        {
            ...
            public Coord Current
            {
                get
                {
                    ...
                    // The extra 0.5 means we draw the line from the middle of the start
                    // cell to the middle of the end cell, as opposed to drawing from bottom 
                    // left corner to bottom left corner.
                    int xOffset = (int)(index * xIncrementor + 0.5f);
                    int yOffset = (int)(index * yIncrementor + 0.5f);
