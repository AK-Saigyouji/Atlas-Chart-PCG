/* This algorithm for generating mazes is based loosely on how Path of Exile appears to do its dungeons. First, a grid
 ...
 adjacent to randomly chosen points in this path until an appropriate number of points is obtained.
  ...
  Start and end cells are marked based on the first and last points in the random path initially generated. 
  
  A major issue with this algorithm is that, as implemented, it's difficult to understand the relationship between
 the parameters and the final result.*/
...
namespace AKSaigyouji.AtlasGeneration
{
    ...
    public sealed class MazeGenBranchingWeightedPath : MazeGenModule
    {
        ...
        [SerializeField] string entranceCell = "Entrance";
        [SerializeField] string exitCell = "Exit";
